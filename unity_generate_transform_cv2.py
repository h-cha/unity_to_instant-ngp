...
def main():
    ...
    res_path = os.path.join(data_dir, "transforms_cv2.json")
    ...
    for idx, im in enumerate(images):
        ...
        print(unity_rob_q, unity_rob_pos)
    ...
    for f in transform_dict["frames"]:
        f["transform_matrix"] = np.matmul(
            f["transform_matrix"], flip_mat)  # flip cameras (it just works)
...
if __name__ == "__main__":
    path = "./data/230629_remocon1/xarm_position_xyz.txt"
